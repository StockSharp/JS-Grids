...
// Serves the repo root on :8793; browse http://localhost:8793/demo/index.html.
...
}).listen(PORT, HOST, () => console.log(`serving Grids on http://${HOST}:${PORT}/demo/index.html (LAN-reachable when HOST is 0.0.0.0)`));
